...
class SRData(data.Dataset):
    def __init__(self, args, train=True):
        ...
        if (
            ...
            and self.args.interp != "nearest"
            and self.args.interp != "lanczos"
            and self.args.interp != "bilinear"
        ):
    ...
    def _get_patch(self, lr, hr):
        ...
        lr = self.input_transform(
            lr, self.args.std_lr_width, self.args.std_lr_height, self.args.gauss_std
        )
